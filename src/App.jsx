...
export default function App() {
  ...
  const [pForm, setPForm] = useState({title:"",genre:"",synopsis:"",chars:"",world:"",chapters:"",where:"",stuck:"",excites:"",currentChapter:""});
  ...
  const send=async()=>{
    ...
    const pCtx = project ? `\n\nPROJECT: "${project.title}". Genre: ${project.genre}. Synopsis: ${project.synopsis}. Characters: ${project.chars}. World: ${project.world}. Chapters so far: ${project.chapters}. Current point: ${project.where}. Stuck on: ${project.stuck}. What excites them: ${project.excites}.${project.currentChapter?` CURRENT CHAPTER TEXT: ${project.currentChapter}`:""}` : "";
